...
This is the implementation of Random Forest Classification Method on time 
series data. 
Features to get input is generated by LaTiP, the same as Unibagging
...
class_file_path = r'E:\Research\LandCoverMapping\Experiment\qianshan\Final_2\Classification\ImageData\out\class_rf_fit_tri.tif'
...
clf_RF.fit(data_tuple[0], data_tuple[1])

t2 = time.time()
print("rf_fit_tri fitting time: " + str(t2 - t1))

# Predict lables based on image data
t3 = time.time()
z_ps=clf_RF.predict(data_tuple[2][0])
t4 = time.time()
print("rf_fit_tri predicting time: " + str(t4 - t3))
